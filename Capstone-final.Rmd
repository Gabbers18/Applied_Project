...
```{r MEA}
mea_normal <- readMEA("/Users/gabrielleyoung/Desktop/DataAP/TxtFiles_cleaned", 
...
``` {r run-all}
# Define folder path
MEA_folder_path2 <- "/Users/gabrielleyoung/Desktop/DataAP/Individual_MEA_Files2"
...
write.csv(clean_results, file = "/Users/gabrielleyoung/Desktop/Final_CRQA_Results.csv", row.names = FALSE)
```
