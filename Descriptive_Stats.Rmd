...
# Open results
```{r results}
results <- read.csv("/Users/gabrielleyoung/Desktop/Capstone_Project/Final_CRQA_Results\ copy.csv")
```
...
# Export as CSV
```{r csv}
write.csv(descriptives_results, file = "/Users/gabrielleyoung/Desktop/CRQA_Descriptives_Results.csv", row.names = FALSE)
```
