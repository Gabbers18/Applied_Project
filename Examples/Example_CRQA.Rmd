...
# language and movement. It captures non-linear patterns and synchorny over time. 
```{r sample-dataset}
dyad16_data <- read.csv("/Users/gabrielleyoung/Desktop/dyad_16_MEA.csv")
...
# Function to extract the middle 60% of the time series; consider using this 
# function if you receive: Warning: sparse->dense coercion: allocating vector of 
# size 1.2 GiBError: vector memory exhausted (limit reached?)
